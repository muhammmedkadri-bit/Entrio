  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <form className="flex flex-col flex-1 overflow-hidden">
        ...
        {/* Footer */}
        <div className="flex-shrink-0 px-4 sm:px-5 py-4 pb-14 sm:pb-4 border-t border-slate-200 bg-slate-50 flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5">
