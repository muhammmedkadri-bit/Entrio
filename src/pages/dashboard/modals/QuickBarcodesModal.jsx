            ...
            <div className="flex flex-col flex-1 overflow-hidden p-6">
              {isLoading ? (
                ...
                <>
                  ...
                  {/* Picker Pagination */}
                  {pickerTotalPages > 1 && (
                    <div className="flex items-center justify-between mt-4 pt-4 pb-14 sm:pb-0 border-t border-slate-200 flex-none">
          ...
          <>
            ...
            <div className="flex flex-col flex-1 overflow-hidden p-6">
              ...
              {!isLoading && displayedBarcodeProducts.length > 0 && (
                <div className="flex items-center justify-between mt-6 pt-4 pb-14 sm:pb-0 border-t border-slate-200 flex-none px-2">
